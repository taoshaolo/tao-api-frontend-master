import {listInterfaceInfoVOByUserIdPageUsingPOST} from '@/services/tao-api-backend/interfaceInfoController';
import {ShareAltOutlined} from '@ant-design/icons';
import {PageContainer} from '@ant-design/pro-components';
import {history} from '@umijs/max';
import {Card, Col, Layout, List, message, Pagination, PaginationProps, Row, Tooltip} from 'antd';
                                    ...
                                    actions={[
                                        ...
                                        >
                                            <div>
                                                ...
                                                <CopyToClipboard text={(item?.host ?? '') + (item?.url ?? '')}
                                                                 onCopy={() => alert('已复制链接，分享即用!')}>
                                                    <ShareAltOutlined/>
